...
- Visual context routing (`context-router.ts`, not re-audited this pass - vision-in-conversation/video understanding above bypass it with a new, simpler direct path)

**Success Criteria:** JARVIS can see and understand environment. Screen-based vision: confirmed live, and now reachable from real conversation. Video understanding: confirmed live via frame sampling. Camera-based vision: not built, deferred.
