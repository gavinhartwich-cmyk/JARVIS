...
- Fish Audio (Gavin's custom "jarvis" voice, primary as of 2026-08-31 - see `src/phase2/tts-provider.ts`)
- Piper (local, free, automatic fallback if Fish Audio errors)
...
| TTS | Fish Audio (primary, Gavin's custom voice), Piper (fallback) | Fish Audio 2026-08-31 for a specific real voice; Piper kept as a free/local fallback if Fish Audio is unreachable |
