...
async function main() {
  ...
  try {
    ...
    if (command === "test" || command === "") {
      ...
      // this trades away (only open_app/close_app/play_music/pause_music/
      // resume_music as tools so far, no
      ...
      console.log('  bun run dev listen-live - Same, but backed by Gemini Live (real, ~3.8x faster measured; needs GEMINI_API_KEY, fewer capabilities - open/close app + play/pause/resume music only)');
